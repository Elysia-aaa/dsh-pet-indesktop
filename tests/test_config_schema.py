...
RELOAD_WHITELIST_SNAPSHOT = frozenset({
    ...
    "music_sing_enabled", "music_sing_grace_seconds",
    "music_lyric_enabled", "music_lyric_cache_limit",
    "music_lyric_lead_seconds", "agent_cost_enabled",
    "no_move", "on_top", "pet_opacity", "playback_speed",
